...
namespace App.Infrastructure.JwtToken
{
    ...
    {
        private readonly Core.Options.JwtSettings _jwtSettings;
        private readonly UserManager<AppUser> userManager;

        public JwtGenerateTokenService(IOptions<Core.Options.JwtSettings> jwtSettings, UserManager<AppUser> userManager)
        {
