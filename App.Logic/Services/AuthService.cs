...
namespace App.Logic.Services
{
    public class AuthService
    {
        ...
        private readonly Core.Options.JwtSettings jwtSettings;
        ...
        public AuthService(IJwtTokenService tokenService, IRefreshTokenRepository refreshTokenRepository, UserManager<AppUser> userManager, IOptions<Core.Options.JwtSettings> jwtOptions, IHttpContextAccessor httpContextAccessor, ILogger<AuthService> logger, IRedisService redisService, IUnitOfWork unitOfWork, ICurrentUserService currentUserService)
        {
